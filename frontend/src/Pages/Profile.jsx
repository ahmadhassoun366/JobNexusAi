...
const Profile = () => {
  ...
  const getSeeker = async () => {
    ...
    // setFirst_name(seekerData?.user.first_name);
    // setLast_name(seekerData?.user.last_name);
    // setPhone(seekerData?.user.phone);
    // setCountry(seekerData?.country.name);
    // setAbout(seekerData?.about);
    // setEducation(seekerData?.education);
    // setTitle(seekerData?.title);
    // setExperience(seekerData?.experience);
    // setSkills(seekerData?.skill);
    // setLanguage(seekerData?.language);
  ...
  //   console.log(seeker?.user.first_name);
  //   setFirst_name(seeker?.user.first_name);
  //   setLast_name(seeker?.user.last_name);
  //   setPhone(seeker?.user.phone);
  //   setCountry(seeker?.country.name);
  //   setAbout(seeker?.about);
  //   setEducation(seeker?.education);
  //   setTitle(seeker?.title);
  //   setExperience(seeker?.experience);
  //   setSkills(seeker?.skill);
  //   setLanguage(seeker?.language);
