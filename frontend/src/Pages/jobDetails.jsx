        ...
        <div className="md:flex flex-row md:-mx-2 mt-8">
          ...
          <div className="w-full md:w-3/12 md:mx-2">
            ...
            <div className="bg-white p-3 space-y-5">
              <div className="image overflow-hidden md:shadow-2xl rounded-full">
                <img
                  className="h-44 w-44 mx-auto md:h-full md:w-full"
                  src={`${process.env.REACT_APP_JOB_API_URL}/${job?.company.logo}`}
                  alt="" />
              </div>
              <h2 className="text-gray-600 text-xl md:text-2xl font-semibold text-center my-2">
                {job?.title}</h2>
              <p className="text-gray-500 hover:text-gray-600 text-xl text-center my-2">
                {job?.company.field}
              </p>
              <h1 className="text-3xl text-gray-800 font-bold text-center">
                <span className="text-2xl text-red-500">Deadline:</span> {job?.deadline}</h1>
          ...
          {/* <!-- Right Side --> */}
          <div className="w-full md:w-9/12 md:mx-2 mt-8 md:mt-0">
            {/* <!-- Profile tab --> */}
            <h1 className="text-center text-4xl text-gray-900 font-semibold">
              {job?.title} at {job?.company.name}</h1>
