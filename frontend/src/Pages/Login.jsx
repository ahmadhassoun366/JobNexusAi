	...
	<div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
		...
		<form className="mt-8 space-y-6" onSubmit={handleLogin}>
			...
			<div className="mt-8 content-center">
				...
				<input type='password' value={password} onChange={handlePasswordChange} className="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" 
			...
			<div>
				<button type="submit" className="w-full flex justify-center bg-gray-500 text-gray-100 p-4  rounded-full tracking-wide
			...
			<p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
				...
				<Link to='/register' className="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign up</Link>
			</p>
		</form>
	</div>
</div>
